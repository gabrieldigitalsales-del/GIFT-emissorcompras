...
alter table public.gift_pc_orders add column if not exists rejection_reason text;
alter table public.gift_pc_orders add column if not exists payment_date date;
alter table public.gift_pc_orders add column if not exists payment_method text;
alter table public.gift_pc_orders add column if not exists payment_responsible text;
...
drop policy if exists "gift_pc_receipts_delete" on storage.objects;
...
create policy "gift_pc_receipts_delete"
